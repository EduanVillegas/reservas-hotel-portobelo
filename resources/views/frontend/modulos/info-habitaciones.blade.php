    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8 colIzqHabitaciones p-0">
                ...
                <div class="pt-4 cabeceraHabitacion">
                    ...
                    <ul class="nav nav-justified mt-lg-4">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-white" orden="{{$key}}" ruta="{{$ruta}} href=" #">
                                {{$value["estilo"]}}
                            </a>
                    ...
                    <div class="slide-inner">
                        ...
                        <ul class="slide-area">
                            ...
                            <li>
                                ...
                                <img src="{{url('img/'.$value)}}" class="img-fluid">
                ...
                <iframe width="100%" height="380" src="https://www.youtube.com/embed/{{$habitaciones[0]["video"]}}" frameborder="0"
                ...
                <div class="descripcionHabitacion px-3">
                    ...
                    <div class="float-right pt-2">
                        ...
                        <button type="button" class="btn btn-default" vista="video"><i class="fab fa-youtube"></i>
                            Video</button>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum sit, quia blanditiis fugiat nam
                        libero possimus totam modi sint autem repellat fugit dicta est pariatur? Ut aut vel ad sapiente.
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae, reprehenderit! Deserunt
                        laborum dolorum deleniti molestiae quae vitae animi ratione nihil, minus ut quibusdam incidunt
                        ...
                        <div class="row py-2" style="background:#509CC3">
                            ...
                            <div class="col-12 col-md-6 mt-2 mt-lg-0 input-group">
                                ...
                                <a href="{{-- <?php echo $ruta;  ?>reservas --}}" class="w-100">
                                    <input type="button" class="btn btn-block btn-md text-white"
