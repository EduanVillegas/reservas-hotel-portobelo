    ...
    <div class="container">
        ...
        <div class="grid-container">
            ...
            <div class="grid-item carta">
                ...
                <div class="row p-1 p-lg-5">
                    ...
                    <div class="col-6 col-md-4 text-center p-1">
                        ...
                        <img src="{{url('img/restaurante/'.$item->img)}}" class="img-fluid w-50 rounded-circle">

                        <p class="py-2">{{$item->descripcion}}</p>
            ...
            <div class="grid-item bloqueRestaurante">
                ...
                <p class="p-4 my-lg-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo beatae nemo,
